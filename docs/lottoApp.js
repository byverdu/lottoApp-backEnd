...
import {
  HelperDate, HelperString, HelperArray, HelperObject, HelperNumber
}
from './preHelpers';
 ...
 * @param {Array} allResults - Storage for all the results
 */
export function LottoSchema() {

    this.lottoID = String;
    this.date = String;
    this.extras = String;
    this.lastResult = String;
    this.mostRepeated = String;
     ...
     */
    this.setLastResult = function(array) {
     ...
     */
    this.setLastResultStars = function(array) {
     ...
     */
    this.setMostRepeated = function(count) {
      let newStatistics,
     ...
     * @see {@link LottoSchema}.setStatisticsAfterColorSet
     */
    this.setMostRepeatedStars = function(count) {
      let newStatistics,
     ...
     */
    this.setAllResults = function(lastResult) {
     ...
     * @return {Array}             - this.allResults + lastResult
     */
    this.setAllResultStars = function() {
     ...
     */
    this.setStatistics = function(array, kind) {
     ...
     * @see {@link LottoSchema}.getCountAllResults
     */
    this.setStatisticStars = function(array, kind) {
     ...
     */
    this.setStatisticsAfterColorSet = function(array) {
     ...
     */
    this.getAllResultsStars = function() {
     ...
     */
    this.getCountAllResults = function(array, kind) {
     ...
     */
    this.getStatisticStars = function() {
      return this.stars.statistics;
    };
